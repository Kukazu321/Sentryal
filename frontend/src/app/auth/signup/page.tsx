    ...
    const onSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (err) {
                ...
                // For email confirmation flow (Supabase), user isn't signed in yet.
                // Persist email for callback/resend convenience.
                try { localStorage.setItem('lastSignupEmail', email.trim()); } catch { }
                const target = `/auth/check-email?email=${encodeURIComponent(email.trim())}`;
    ...
    return (
        ...
        >
            ...
            >
                ...
                >
                    <h1 style={{ fontSize: '28px', fontWeight: 'bold', color: '#333', marginBottom: '8px', textAlign: 'left' }}>
                        Create your account
                    </h1>
                    <p style={{ fontSize: '16px', color: '#666', marginBottom: '32px', textAlign: 'left', lineHeight: '1.4' }}>
                        Monitor infrastructure deformation in a clean, modern, professional interface.
                    </p>
                    ...
                    <form onSubmit={onSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
                        ...
                        <div>
                            <label htmlFor="email" style={{ display: 'block', fontSize: '14px', color: '#333', marginBottom: '4px' }}>
                                Email
                            </label>
                            <input
                                type="email"
                        ...
                        <div>
                            <label htmlFor="password" style={{ display: 'block', fontSize: '14px', color: '#333', marginBottom: '4px' }}>
                                Password
                            </label>
                            <input
                                type="password"
                        ...
                        <div style={{ fontSize: '14px', color: '#555', marginTop: '8px' }}>
                            Already have an account? <a href="/auth/login" style={{ color: '#000', textDecoration: 'underline' }}>Log in</a>
                        </div>
                        <hr
                            style={{
                                border: 'none',
                        ...
                        >
                            ...
                            <span style={{ lineHeight: 1.2 }}>Sign up with SAML 2.0</span>
                        </button>
                        <button
                            type="button"
                            style={{
                        ...
                        >
                            ...
                            <span style={{ lineHeight: 1.2 }}>Sign up with Azure</span>
                        </button>
                    </form>
                </div>
                <div
